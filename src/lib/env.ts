...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_BUSINESS_ADDRESS: z.string().default("Bình Dương, Việt Nam"),
  NEXT_PUBLIC_HOTLINE: z.string().default("0900000000"),
  NEXT_PUBLIC_ZALO: z.string().default("0900000000"),
  NEXT_PUBLIC_MESSENGER: z.string().default("https://m.me/anhtaomobile"),
  NEXT_PUBLIC_MAPS_URL: z
    .string()
    .default("https://maps.google.com/?q=Anh+Tao+Mobile+Binh+Duong"),
...
function parseEnv() {
  if (typeof window !== "undefined") {
    return {
      ...
      NEXT_PUBLIC_BUSINESS_ADDRESS: process.env.NEXT_PUBLIC_BUSINESS_ADDRESS || "Bình Dương, Việt Nam",
      NEXT_PUBLIC_HOTLINE: process.env.NEXT_PUBLIC_HOTLINE || "0900000000",
      NEXT_PUBLIC_ZALO: process.env.NEXT_PUBLIC_ZALO || "0900000000",
      NEXT_PUBLIC_MESSENGER: process.env.NEXT_PUBLIC_MESSENGER || "https://m.me/anhtaomobile",
      NEXT_PUBLIC_MAPS_URL: process.env.NEXT_PUBLIC_MAPS_URL || "https://maps.google.com/?q=Anh+Tao+Mobile+Binh+Duong",
